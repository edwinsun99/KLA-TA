...
<body>
    ...
    <header class="header">
        ...
        <div class="header-right">
            <a href="{{ route('consul.new') }}" class="text-decoration-none">
...
<small class="text-muted d-block">
    {{ ucfirst(strtolower(Auth::user()->role)) }}
                    ...
                    <li><a class="dropdown-item py-2" href="#"><i class="bi bi-person-gear me-2"></i> Edit Profil</a></li>
    ...
    <nav class="sidebar" id="mySidebar">
        <a href="{{ route('cust.home') }}" class="menu-item mt-2 {{ request()->routeIs('ce.home') ? 'active' : '' }}">
        ...
        <div class="accordion accordion-flush" id="sidebarAccordion">
            <div class="accordion-item border-0 bg-transparent">
                ...
                <a href="#menuCases" class="menu-item {{ $caseActive ? 'active' : '' }}" data-bs-toggle="collapse">
                    <i class="bi bi-folder"></i> <span>Konsultasi</span>
                </a>
                <div id="menuCases" class="collapse {{ $caseActive ? 'show' : '' }}" data-bs-parent="#sidebarAccordion">
                    <div class="submenu-container">
                        <a href="{{ route('consul.new') }}" class="submenu-item {{ request()->routeIs('consul.new') ? 'active-sub' : '' }}">Buat Konsultasi</a>
                        <a href="{{ route('consul.act') }}" class="submenu-item {{ request()->routeIs('consul.act') ? 'active-sub' : '' }}">Konsultasi Aktif</a>
                        <a href="{{ route('consul.hst') }}" class="submenu-item {{ request()->routeIs('consul.hst') ? 'active-sub' : '' }}">Riwayat Konsultasi</a>
                    </div>
                </div>
            </div>
        </div>

        <a href="{{ route('my.cases') }}" class="menu-item {{ request()->routeIs('my.cases') ? 'active' : '' }}">
            <i class="bi bi-wrench-adjustable"></i> <span>My Cases</span>
        </a>
        <a href="{{ route('cust.notif') }}" class="menu-item {{ request()->routeIs('cust.notif') ? 'active' : '' }}">
            <i class="bi bi-gem"></i> <span>Notifikasi</span>
        </a>
    </nav>
